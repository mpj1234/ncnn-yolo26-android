...
public class MpjYolo26 {
     ...
     * @param targetSize     输入尺寸
     * @param prob_threshold 置信度阈值
     * @param cpugpu         0:cpu 1:gpu
     * @return 是否加载成功
     */
    public static native boolean loadModel(AssetManager assetManager, String modelName, int targetSize, float prob_threshold, int cpugpu, String[] labels);
